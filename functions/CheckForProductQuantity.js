  ...
  if (!invalid) {
    ...
    try {
      ...
      request(options, function (error, response, body) {
        if (!error) {
          log("Do CheckForProductQuantity Callback");
          ...
          logError("Do CheckForProductQuantity Callback error - " + error);
          out.ncStatusCode = 500;
      ...
      logError("Exception occurred in CheckForProductQuantity - " + error);
